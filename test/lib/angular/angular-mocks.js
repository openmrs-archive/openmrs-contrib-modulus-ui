 ...
 *
 * <pre>
 *   modulusOneDev = angular.module('modulusOneDev', ['modulusOne', 'ngMockE2E']);
 *   modulusOneDev.run(function($httpBackend) {
...
if(window.jasmine || window.mocha) {
   ...
   * <pre>
   *
   *   angular.module('modulusOnelicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('modulusOne', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('modulusOnelicationModule'));
   *
   *

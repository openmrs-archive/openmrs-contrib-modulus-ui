 ...
 *
 * <pre>
 * var modulusOne = angular.module('modulusOne', []);
 * modulusOne.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://modulusOne.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://modulusOne.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('modulusOne', []).config(function($sceDelegateProvider) {
 ...
 *        'http://modulusOne.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="modulusOneController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("modulusOneController", function modulusOneController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('modulusOneWithSceDisabledmodulusOne', []).config(function($sceProvider) {
